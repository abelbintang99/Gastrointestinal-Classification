...
BelzClassification adalah aplikasi Full-stack yang membantu klasifikasi kondisi medis Gastrointestinal menggunakan Machine Learning. Aplikasi ini dirancang untuk memberikan referensi cepat bagi tenaga medis melalui analisis gambar endoskopi.
...
1. **Clone Repo**: `git clone https://github.com/username/belz-classification.git`
2. **Setup Backend**:
   - `cd backend`
